...
namespace FrostDB
{
    public class MessageDataAction
    {
        ...
        public class Row
        {
            ...
            public const string Update_Row_Information = "Row.Update_Row_Information";
            public const string Update_Row_Information_Response = "Row.Update_Row_Information_Response";
